...
export default function OnboardingCard({ title, children }: Props) {
  return (
    <div className="width-full mx-auto bg-gradient-to-b from-[#151a25] to-[#0f1117] border border-gray-800 rounded-2xl p-10 sm:p-12 lg:p-16 shadow-xl backdrop-blur-md">
